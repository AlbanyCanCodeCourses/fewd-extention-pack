...
<p>Click <a href="https://marketplace.visualstudio.com/items?itemName=ray-vazquez.acc-fewd-extentionpack">here</a> to download this extention pack from the Visual Studio Code Marketplace</p>

<p>You may download this extention pack it from within VSCode by clicking View > Extentions then search for ACC_FEWD_ExtentionPack</p>
...
<p align="center" style="margin: 0 10%">
  <img src="https://i.giphy.com/iaHeUiDeTUZuo.gif" alt="Path Intellisense for VS Code" />
</p>
